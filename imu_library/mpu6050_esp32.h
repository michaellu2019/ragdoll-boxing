...
#ifndef _mpu6050_esp32_H_
#define _mpu6050_esp32_H_
#include <Wire.h>
#include <Arduino.h>

//Based on several libraries floating around on the web.  Including:
//https://github.com/Bill2462/MPU6050-Arduino-Library/blob/master/src/MPU6050.cpp
//Updated 2017, 2018, 2019, by Joe Steinmeyer for use in 6.08. (jodalyst@mit.edu)

// See also MPU-6050 Register Map and Descriptions, Revision 4.0,
// RM-MPU-6050A-00, Rev. 1.4, 9/9/2013 for registers not listed in above
// document; the MPU6050 and MPU9150 are virtually identical but the latter has
...
#define WHO_AM_I_MPU6050   0x75// was 75 on mpu6050 // Should return 0x71
...
// Using the MPU-6050 breakout board, ADO is set to 0
...
public:
  ...
  public:
    ...
    bool setupIMU(uint8_t timeout); //timeout in seconds
    ...
    void magCalMPU6050(float * dest1, float * dest2);
